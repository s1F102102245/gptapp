...
new core_1.ConsoleLogger('GraphQLAPI');
...
class InternalGraphQLAPIClass {
    ...
    async _headerBasedAuth(amplify, authMode, additionalHeaders = {}) {
        const { region: region, endpoint: appSyncGraphqlEndpoint, apiKey, } = (0, utils_2.resolveConfig)(amplify);
        let headers = {};
        switch (authMode) {
            case 'apiKey':
                if (!apiKey) {
    ...
    async _graphql(amplify, { query, variables, authMode: explicitAuthMode }, additionalHeaders = {}, abortController, customUserAgentDetails, authToken) {
        const { region: region, endpoint: appSyncGraphqlEndpoint, customEndpoint, customEndpointRegion, defaultAuthMode } = (0, utils_2.resolveConfig)(amplify);
        ...
        try {
            ...
            response = {
                data: {},
                errors: [
                    new graphql_1.GraphQLError(err.message, null, null, null, null, err),
                ],
            };
        }
