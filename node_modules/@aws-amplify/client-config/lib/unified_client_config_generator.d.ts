 ...
 */
export declare class UnifiedClientConfigGenerator implements ClientConfigGenerator {
    private readonly fetchOutput;
    private readonly clientConfigContributors;
    /**
     * Provide a reference to how this config generator should retrieve backend output
     */
    constructor(fetchOutput: () => Promise<BackendOutput>, clientConfigContributors: ClientConfigContributor[]);
    /**
...
//# sourceMappingURL=unified_client_config_generator.d.ts.map