...
const validateFieldRules = (authDir, isParentTypeBuiltinType, parentHasModelDirective, fieldName, transformParameters, parent, context) => {
    const rules = authDir.getArguments({ rules: [] }, (0, graphql_transformer_core_1.generateGetArgumentsInput)(transformParameters)).rules;
    if (!isParentTypeBuiltinType && (0, graphql_transformer_core_1.isRDSModel)(context, parent.name.value)) {
