import { AmazonProviderProps, AppleProviderProps, AuthProps, ExternalProviderOptions, FacebookProviderProps, GoogleProviderProps, OidcProviderProps } from '@aws-amplify/auth-construct-alpha';
