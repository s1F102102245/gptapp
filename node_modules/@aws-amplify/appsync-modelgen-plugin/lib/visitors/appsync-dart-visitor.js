            ...
            if (this.isModelType(field)) {
                if (field.isList) {
                    return [
                        ...
                        (0, visitor_plugin_common_1.indent)(`.where((e) => e?['serializedData'] != null)`, 2),
                        (0, visitor_plugin_common_1.indent)(`.map((e) => ${this.getNativeType({
                            ...field,
                            isList: false,
                        })}.fromJson(new Map<String, dynamic>.from(e['serializedData'])))`, 2),
                ...
                return [
                    ...
                    (0, visitor_plugin_common_1.indent)(`? ${this.getNativeType(field)}.fromJson(new Map<String, dynamic>.from(json['${varName}']['serializedData']))`),
                    (0, visitor_plugin_common_1.indent)(`: null`),
                ].join('\n');
            }
            if (this.isEnumType(field)) {
            ...
            if (this.isNonModelType(field)) {
                if (field.isList) {
                    return [
                        ...
                        (0, visitor_plugin_common_1.indent)(`.map((e) => ${this.getNativeType({ ...field, isList: false })}.fromJson(new Map<String, dynamic>.from(${this.isNonModelType(field) ? "e['serializedData']" : 'e'})))`, 2),
                        (0, visitor_plugin_common_1.indent)(`.toList()`, 2),
                        (0, visitor_plugin_common_1.indent)(`: null`),
                    ]
                        .filter(e => e !== undefined)
