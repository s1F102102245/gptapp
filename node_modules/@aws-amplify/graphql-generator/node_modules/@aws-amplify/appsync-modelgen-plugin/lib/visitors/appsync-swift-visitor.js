    ...
    generateFieldSchema(field, modelKeysName) {
        ...
        if (connectionInfo) {
            ...
            if (connectionInfo.kind === process_connections_1.CodeGenConnectionType.HAS_ONE) {
                ...
                return `.hasOne(${name}, is: ${isRequired}, ofType: ${typeName}, associatedWith: ${this.getModelName(connectionInfo.connectedModel)}.keys.${this.getFieldName(connectionInfo.associatedWith)}, ${targetNameAttrStr})`;
            }
