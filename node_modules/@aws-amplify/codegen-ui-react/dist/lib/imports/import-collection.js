...
class ImportCollection {
    ...
    addImport(packageName, importName) {
        ...
        if (packageName === import_mapping_1.ImportSource.LOCAL_MODELS) {
            ...
            const modelAlias = (0, helpers_1.createUniqueName)(importName, (input) => this.importedNames.has(input) || (input.endsWith('Props') && (0, primitive_1.isPrimitive)(input.replace(/Props/g, ''))));
