      ...
      `);
        this.generateResolvers = (context) => {
            ...
            for (const def of this.searchableObjectTypeDefinitions) {
                ...
                resolver.addToSlot('postAuth', graphql_transformer_core_1.MappingTemplate.s3MappingTemplateFromString((0, generate_resolver_vtl_1.sandboxMappingTemplate)(context.transformParameters.sandboxModeEnabled, fields), `${typeName}.${def.fieldName}.{slotName}.{slotIndex}.res.vtl`));
