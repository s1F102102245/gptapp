...
`;
const DDB_DATASOURCE_TYPE = {
    dbType: graphql_transformer_core_1.DDB_DB_TYPE,
    provisionDB: true,
...
class ModelTransformer extends graphql_transformer_core_1.TransformerModelBase {
    constructor(options = {}) {
        ...
        this.modelToDatasourceProvisionTypeMap = new Map();
        this.modelDirectiveConfig = new Map();
        this.before = (ctx) => {
            var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k;
            this.modelToDatasourceProvisionTypeMap = ctx.modelToDatasourceMap;
            const datasourceMapValues = Array.from(this.modelToDatasourceProvisionTypeMap.values());
            if (datasourceMapValues.some((value) => value.dbType === graphql_transformer_core_1.DDB_DB_TYPE && value.provisionDB && value.provisionStrategy === "DEFAULT")) {
                (_a = this.resourceGeneratorMap.get(graphql_transformer_core_1.DDB_DB_TYPE)) === null || _a === void 0 ? void 0 : _a.enableGenerator();
                (_b = this.resourceGeneratorMap.get(graphql_transformer_core_1.DDB_DB_TYPE)) === null || _b === void 0 ? void 0 : _b.enableProvisioned();
            }
            if (datasourceMapValues.some((value) => value.dbType === graphql_transformer_core_1.MYSQL_DB_TYPE && !value.provisionDB)) {
                (_c = this.resourceGeneratorMap.get(graphql_transformer_core_1.MYSQL_DB_TYPE)) === null || _c === void 0 ? void 0 : _c.enableGenerator();
                (_d = this.resourceGeneratorMap.get(graphql_transformer_core_1.MYSQL_DB_TYPE)) === null || _d === void 0 ? void 0 : _d.enableUnprovisioned();
            }
            if (datasourceMapValues.some((value) => value.dbType === graphql_transformer_core_1.POSTGRES_DB_TYPE && !value.provisionDB)) {
                (_e = this.resourceGeneratorMap.get(graphql_transformer_core_1.POSTGRES_DB_TYPE)) === null || _e === void 0 ? void 0 : _e.enableGenerator();
                (_f = this.resourceGeneratorMap.get(graphql_transformer_core_1.POSTGRES_DB_TYPE)) === null || _f === void 0 ? void 0 : _f.enableUnprovisioned();
            }
            if (datasourceMapValues.some((value) => value.dbType === graphql_transformer_core_1.DDB_DB_TYPE && value.provisionDB && value.provisionStrategy === "AMPLIFY_TABLE")) {
                (_g = this.resourceGeneratorMap.get(CUSTOM_DDB_DB_TYPE)) === null || _g === void 0 ? void 0 : _g.enableGenerator();
                (_h = this.resourceGeneratorMap.get(CUSTOM_DDB_DB_TYPE)) === null || _h === void 0 ? void 0 : _h.enableProvisioned();
            }
            if (datasourceMapValues.length === 0) {
                (_j = this.resourceGeneratorMap.get(graphql_transformer_core_1.DDB_DB_TYPE)) === null || _j === void 0 ? void 0 : _j.enableGenerator();
                (_k = this.resourceGeneratorMap.get(graphql_transformer_core_1.DDB_DB_TYPE)) === null || _k === void 0 ? void 0 : _k.enableProvisioned();
            }
        };
        this.object = (definition, directive, ctx) => {
            ...
            const isDynamoDB = ((_a = ctx.modelToDatasourceMap.get(definition.name.value)) !== null && _a !== void 0 ? _a : DDB_DATASOURCE_TYPE).dbType === graphql_transformer_core_1.DDB_DB_TYPE;
            ...
            if (!isDynamoDB) {
                const containsPrimaryKey = (_b = definition.fields) === null || _b === void 0 ? void 0 : _b.some((field) => {
                    var _a;
                ...
                if (!containsPrimaryKey) {
                    throw new graphql_transformer_core_1.InvalidDirectiveError(`RDS model "${definition.name.value}" must contain a primary key field`);
                }
            }
            ...
            if (!ctx.transformParameters.shouldDeepMergeDirectiveConfigDefaults) {
                ...
                if (((_c = baseArgs === null || baseArgs === void 0 ? void 0 : baseArgs.subscriptions) === null || _c === void 0 ? void 0 : _c.level) === directive_1.SubscriptionLevel.public &&
                    !(((_d = baseArgs === null || baseArgs === void 0 ? void 0 : baseArgs.subscriptions) === null || _d === void 0 ? void 0 : _d.onCreate) || ((_e = baseArgs === null || baseArgs === void 0 ? void 0 : baseArgs.subscriptions) === null || _e === void 0 ? void 0 : _e.onDelete) || ((_f = baseArgs === null || baseArgs === void 0 ? void 0 : baseArgs.subscriptions) === null || _f === void 0 ? void 0 : _f.onUpdate))) {
                    options.subscriptions = { level: directive_1.SubscriptionLevel.public, ...publicSubscriptionDefaults };
                }
            }
            if (((_g = options.subscriptions) === null || _g === void 0 ? void 0 : _g.onCreate) && !Array.isArray(options.subscriptions.onCreate)) {
                options.subscriptions.onCreate = [options.subscriptions.onCreate];
            }
            if (((_h = options.subscriptions) === null || _h === void 0 ? void 0 : _h.onDelete) && !Array.isArray(options.subscriptions.onDelete)) {
                options.subscriptions.onDelete = [options.subscriptions.onDelete];
            }
            if (((_j = options.subscriptions) === null || _j === void 0 ? void 0 : _j.onUpdate) && !Array.isArray(options.subscriptions.onUpdate)) {
            ...
            const resourceGenerator = this.getResourceGenerator(typeName);
        ...
        this.transformSchema = (ctx) => {
            ...
            this.typesWithModelDirective.forEach((type) => {
                ...
                if (((_a = ctx.modelToDatasourceMap.get(def.name.value)) !== null && _a !== void 0 ? _a : DDB_DATASOURCE_TYPE).dbType === graphql_transformer_core_1.DDB_DB_TYPE) {
        ...
        this.generateGetResolver = (ctx, type, typeName, fieldName, resolverLogicalId) => {
            const resourceGenerator = this.getResourceGenerator(type.name.value);
            if (resourceGenerator) {
        ...
        this.getInputs = (ctx, type, operation) => {
            ...
            switch (operation.type) {
                ...
                case graphql_transformer_interfaces_1.SubscriptionFieldType.ON_UPDATE: {
                    const filterInputName = (0, graphql_transformer_common_1.toPascalCase)(['ModelSubscription', type.name.value, 'FilterInput']);
                    const filterInputs = (0, graphql_types_1.createEnumModelFilters)(ctx, type);
        ...
        this.getResourceGenerator = (typeName) => {
            var _a;
            const datasourceType = (_a = this.modelToDatasourceProvisionTypeMap.get(typeName)) !== null && _a !== void 0 ? _a : DDB_DATASOURCE_TYPE;
            if (datasourceType.dbType === graphql_transformer_core_1.DDB_DB_TYPE && datasourceType.provisionStrategy === "DEFAULT") {
                return this.resourceGeneratorMap.get(graphql_transformer_core_1.DDB_DB_TYPE);
            }
            else if (datasourceType.dbType === graphql_transformer_core_1.DDB_DB_TYPE && datasourceType.provisionStrategy === "AMPLIFY_TABLE") {
        ...
        this.resourceGeneratorMap.set(graphql_transformer_core_1.MYSQL_DB_TYPE, new rds_model_resource_generator_1.RdsModelResourceGenerator());
        this.resourceGeneratorMap.set(graphql_transformer_core_1.POSTGRES_DB_TYPE, new rds_model_resource_generator_1.RdsModelResourceGenerator());
        this.resourceGeneratorMap.set(CUSTOM_DDB_DB_TYPE, new amplify_dynamo_model_resource_generator_1.AmplifyDynamoModelResourceGenerator());
    }
}
