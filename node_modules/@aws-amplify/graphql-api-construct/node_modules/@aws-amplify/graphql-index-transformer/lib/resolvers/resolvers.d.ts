import { TransformerContextProvider, TransformerResolverProvider, DBType, DataSourceType } from '@aws-amplify/graphql-transformer-interfaces';
...
export declare const makeQueryResolver: (config: IndexDirectiveConfiguration, ctx: TransformerContextProvider, dbType: DBType) => void;
...
export declare const getDBInfo: (ctx: TransformerContextProvider, modelName: string) => DataSourceType;
export declare const getDBType: (ctx: TransformerContextProvider, modelName: string) => DBType;
export declare const getVTLGenerator: (dbInfo: DataSourceType | undefined) => RDSIndexVTLGenerator | DynamoDBIndexVTLGenerator;
