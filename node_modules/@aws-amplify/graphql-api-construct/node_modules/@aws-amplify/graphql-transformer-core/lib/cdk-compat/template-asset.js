...
const asset_manager_1 = require("../transformer-context/asset-manager");
class S3MappingFunctionCode {
    ...
    bind(scope) {
        if (!this.asset) {
            this.asset = asset_manager_1.assetManager.createAsset(scope, `Code${this.fileName}`, {
...
class S3MappingTemplate {
    ...
    bind(scope) {
        if (!this.asset) {
            this.asset = asset_manager_1.assetManager.createAsset(scope, `Template${this.name}`, {
